...
public class SettingsPanel extends JPanel {
  ...
  private void initializePropertyDefinitions() {
    ...
    propertyDefinitions
        .put("org.eclipse.jdt.core.formatter.comment.count_line_length_from_starting_position",
            new PropertyDefinition(new String[] {"true", "false"},
                PropertyDefinition.ComponentType.CHECKBOX,
    ...
    switch (def.componentType) {
      ...
      case CHECKBOX:
        if (component instanceof JCheckBox) {
          ...
          if (def.possibleValues.length > 0 && (def.possibleValues[0].equals("insert")
              || def.possibleValues[0].equals("do not insert"))) {
  ...
  private JPanel createBasicTab() {
    ...
    settingComponents.put("org.eclipse.jdt.core.formatter.comment.line_length",
        commentLineLengthSpinner);
    ...
    settingComponents.put("org.eclipse.jdt.core.formatter.continuation_indentation",
        continuationSpinner);
  ...
  private JPanel createBracesTab() {
    ...
    gbc.gridx = 1;
    JComboBox<String> typeBraceCombo =
        new JComboBox<>(new String[] {"end_of_line", "next_line", "next_line_indented"});
    settingComponents.put("org.eclipse.jdt.core.formatter.brace_position_for_type_declaration",
        typeBraceCombo);
    ...
    gbc.gridx = 1;
    JComboBox<String> methodBraceCombo =
        new JComboBox<>(new String[] {"end_of_line", "next_line", "next_line_indented"});
    settingComponents.put("org.eclipse.jdt.core.formatter.brace_position_for_method_declaration",
        methodBraceCombo);
    ...
    gbc.gridx = 1;
    JComboBox<String> constructorBraceCombo =
        new JComboBox<>(new String[] {"end_of_line", "next_line", "next_line_indented"});
    settingComponents.put(
        "org.eclipse.jdt.core.formatter.brace_position_for_constructor_declaration",
    ...
    gbc.gridx = 1;
    JComboBox<String> blockBraceCombo =
        new JComboBox<>(new String[] {"end_of_line", "next_line", "next_line_indented"});
    settingComponents.put("org.eclipse.jdt.core.formatter.brace_position_for_block",
        blockBraceCombo);
    ...
    gbc.gridx = 1;
    JComboBox<String> switchBraceCombo =
        new JComboBox<>(new String[] {"end_of_line", "next_line", "next_line_indented"});
    settingComponents.put("org.eclipse.jdt.core.formatter.brace_position_for_switch",
        switchBraceCombo);
  ...
  private JPanel createLineWrappingTab() {
    ...
    settingComponents.put("org.eclipse.jdt.core.formatter.never_join_already_wrapped_lines",
        neverJoinCheckBox);
    ...
    settingComponents.put("org.eclipse.jdt.core.formatter.align_with_spaces",
        alignWithSpacesCheckBox);
  ...
  private JPanel createCommentsTab() {
    ...
    settingComponents.put("org.eclipse.jdt.core.formatter.comment.format_javadoc_comments",
        formatJavadocCheckBox);
    ...
    settingComponents.put("org.eclipse.jdt.core.formatter.comment.indent_root_tags",
        indentRootTagsCheckBox);
    ...
    for (JComponent component : settingComponents.values()) {
      if (component instanceof JSpinner) {
        ...
        throw new IllegalArgumentException(
            "Unsupported component type: " + component.getClass().getName());
      }
    }
  }
  ...
  private void loadPreset(String presetName) {
    try {
      Map<String, String> settings =
          dev.jbang.fmt.JavaFormatter.loadSettingsFromClasspath(presetName);
      loadSettings(settings);
      onSettingsChanged.run();
    } catch (Exception e) {
      JOptionPane.showMessageDialog(this, "Error loading preset: " + e.getMessage(), "Error",
  ...
  private class SettingsTableModel extends AbstractTableModel {
    ...
    public void refreshData() {
      ...
      String[] knownSettings = {"org.eclipse.jdt.core.formatter.lineSplit",
